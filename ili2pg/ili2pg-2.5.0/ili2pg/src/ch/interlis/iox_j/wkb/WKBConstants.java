...
public interface WKBConstants {
  ...
  int wkbIncludesZ = 1000;
  int wkbIncludesM = 2000;
  int wkbIncludesZM = 3000;
  int ewkbIncludesZ=0x80000000;
  int ewkbIncludesM=0x40000000;
  int ewkbIncludesSRID=0x20000000;
}
